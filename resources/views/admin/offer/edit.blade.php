                            ...
                            <form action="{{route('admin.offer.update')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="inputEnterYourName" value="{{ $offer->offer_amount }}" name="offer_amount" placeholder="Enter Offer Amount(%)">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img src="{{Storage::url($offer['offer_image'])}}" style="width: 100px; height:100px;" alt=""></a>
