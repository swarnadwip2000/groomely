        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h6 class="mb-0 text-uppercase">Create Service Type</h6>
                    <hr>
                            ...
                            <form action="{{route('service-type.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="inputEnterYourName" value="{{old('name')}}" name="name" placeholder="Enter Service Type Name">
                                            @if($errors->has('name'))
