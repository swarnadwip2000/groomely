    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Additional Services</div>
                <div class="ps-3">
                ...
                <div class="card-body">
                    <div class="card-title">
                        <div class="row">
                            ...
                            <div class="col-md-6"><a href="{{route('additional-service.create',$service_type)}}" style="float: right;"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i>
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                <form action="{{route('additional-service.update')}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="service_typeId" value="{{$service_type}}">
