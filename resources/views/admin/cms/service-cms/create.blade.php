    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Service Cms Create</div>
                <div class="ps-3">
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h6 class="mb-0 text-uppercase">Create Service Cms</h6>
                    <hr>
                    <div class="card border-top border-0 border-4 border-info">
                        <div class="card-body">
                            <form action="{{route('service-cms.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="border p-4 rounded">
                                    <div class="row mb-3">
                                        <label for="inputEnterYourName" class="col-sm-3 col-form-label">Name <span style="color: red;">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="inputEnterYourName" value="{{old('name')}}" name="name" placeholder="Enter Your Service-cms Name">
                                            @if($errors->has('name'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="inputEnterYourName" value="{{old('title')}}" name="title" placeholder="Enter Your Service-cms Title">
                                            @if($errors->has('title'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="inputEnterYourName" value="{{old('description')}}" name="description" placeholder="Enter Your Service-cms Description"></textarea>
                                    ...
                                    <div class="row mb-3 prevwimg" style="display:none;">
                                    ...
                                    <div class="row mb-3 prevwicn" style="display:none;">
                                        <label for="inputEnterYourName" class="col-sm-3 col-form-label"></label>
                                        <div class="col-sm-3 mb-2">
                                            <img id="preview-icon-before-upload" src=""
                                                alt="preview image" style="max-height: 100px;">
                                        </div>
                                    </div>
