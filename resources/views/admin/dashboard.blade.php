                        ...
                        <div class="card radius-15 w-100">
                            <div class="card-body">
                                <div class="card-title">
                                    ...
                                    <div class="col-md-6"
                                        style="align: right; position: absolute; top: 8px; right: -170px;">
                                        <form action="{{ route('admin.transaction.download') }}" method="post">
                                            ...
                                            <a href="#"><button class="btn btn-primary" type="submit"> <i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6">
                                        <input type="date" value="{{ date('Y-m-d') }}" id="start_date"
                                            class=" form-control">
                                    </div>
                                    <div class="col-6 col-lg-6">
                                        <input type="date" id="end_date"
                                            value="{{ date('Y-m-d', strtotime('30 days')) }}"
                                            class="col-5 col-lg-5 form-control" readonly>
                                    </div>
