                            ...
                            <form action="{{route('booking-history.reshedule.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="inputPhoneNo2" value="{{date('Y-m-d',strtotime($appointment['booking_date']))}}" name="booking_date" min="{{date('Y-m-d',strtotime('today'))}}">
