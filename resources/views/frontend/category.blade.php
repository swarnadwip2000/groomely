            ...
            <div class="col-md-3">
                <div class="feature_box">
                    ...
                    <h4>{{$service['additionalService']['name']}}</h4>
                        ...
                        <p class="star">@if($service->totalRatingService($service['id']) !='')<i class="fa-solid fa-star"></i> {{$service->totalRatingService($service['id'])}} ({{$service->review()->count()}})@endif</p>
                        <div class="d-flex align-items-center py-2">
                            {{-- <div class="price">${{$service['rate']}}</div> --}}
                            <p><i class="fa-regular fa-clock"></i> {{ date('h', strtotime($service['duration'])) }} hr
