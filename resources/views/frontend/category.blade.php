                ...
                <div class="feature_box">
                    ...
                    <h4>{{$service['service']['additionalService']['name']}}</h4>
                        ...
                        <div class="d-flex align-items-center py-2">
                            ...
                            <p><i class="fa-regular fa-clock"></i> {{ date('h', strtotime($service['service']['duration'])) }} hr
                        ...
                        <a href="{{route('book-now', base64_encode($service['service']['id']))}}" class="buttonfx slidebottomleft animated" data-animation-in="fadeInUp" href="book-an-appointment.html"><span>BOOK NOW</span></a>
                    </div>
                </div>
            </div>
        @endforeach
